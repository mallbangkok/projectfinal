...
public class UpdateArticleManager {
	...
	public String isUpdateArticle(long articleid, String articlename, String filename, String articledatetime,
			String articletype, String content) {
		String message = "";
		Article article = new Article(articleid, articlename, filename, getCurrentDate(), 0, articletype);
		message = this.doHibernateUpdateArticle(article);
	...
	public void saveFile(String filename, String content) {
		String FILENAME = "C:\\Users\\demon\\Documents\\GitHub\\projectfinal\\WebContent\\WEB-INF\\assets\\article\\"
				+ filename + ".txt";
	...
	public String readFile(String filename) throws IOException {
		BufferedReader br = new BufferedReader(new FileReader(
				"C:\\Users\\demon\\Documents\\GitHub\\projectfinal\\WebContent\\WEB-INF\\assets\\article\\"
						+ filename));
		try {
