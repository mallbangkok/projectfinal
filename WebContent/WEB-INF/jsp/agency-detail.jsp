...
<link rel="stylesheet" href="css/style.css" type="text/css">
    ...
    <title>Zoner | Agency Detail</title>
            ...
            <header class="navbar" id="top" role="banner">
                <div class="navbar-header">
                    ...
                    <div class="navbar-brand nav" id="brand">
                        ...
                        <img src="<c:url value="/img/logo.png"/>" alt=""></a>
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9">
                    <section id="agent-detail">
                        <header><h1>Genius Properties</h1></header>
                        <section id="agent-info">
                            <div class="row">
                                <div class="col-md-3 col-sm-3">
                                    <figure class="agency-image">
                                     <img src="<c:url value="/img/agency-logo-big-01.png"/>" alt="">
                                   </figure>
                                </div><!-- /.col-md-3 -->
                        ...
                        <section id="agent-properties">
                            <header><h3>Our Properties (24)</h3></header>
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-4">
                                        <div class="property">
                                            <a href="property-detail.html">
                                                <div class="property-image">
                                                    <img src="<c:url value="/img/properties/property-13.jpg"/>" alt="">
                                                </div>
                                                <div class="overlay">
                                                    <div class="info">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        <div class="property">
                                            <a href="property-detail.html">
                                                <div class="property-image">
                                                   <img src="<c:url value="/img/properties/property-11.jpg"/>" alt="">
                                                </div>
                                                <div class="overlay">
                                                    <div class="info">
                        ...
                        <section id="agents-listing">
                            <header><h3>Our Agents</h3></header>
                            <div class="row">
                                ...
                                <div class="col-md-12 col-lg-6">
                                    <div class="agent">
                                        <a href="agent-detail.html" class="agent-image">
                                        <img src="<c:url value="/img/member-01.jpg"/>" alt="">
                           </a>
                                        <div class="wrapper">
                                ...
                                <div class="col-md-12 col-lg-6">
                                    <div class="agent">
                                        <a href="agent-detail.html" class="agent-image">
                                        <img src="<c:url value="/img/member-03.jpg"/>" alt=""> </a>
                                ...
                                <div class="col-md-12 col-lg-6">
                                    <div class="agent">
                                        <a href="agent-detail.html" class="agent-image">
                                            <img src="<c:url value="/img/member-04.jpg"/>" alt=""> </a>
                                        <div class="wrapper">
