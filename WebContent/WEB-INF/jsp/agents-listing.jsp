            ...
            <div class="container">
                ...
                <div class="user-area">
                    ...
                    <div class="language-bar">
                        ...
                        <a href="#"> <img src="<c:url value="/img/flags/de.png"/>" alt="">
							</a>
                        <a href="#"> <img src="<c:url value="/img/flags/es.png"/>" alt="">
							</a>
                    </div>
                </div>
            </div>
                    ...
                    <section id="agents-listing">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-lg-6">
                                <div class="agent">
                                    <a href="agent-detail.html" class="agent-image">
                                     <img src="<c:url value="/img/agent-01.jpg"/>" alt="">	</a>
                            ...
                            <div class="col-md-12 col-lg-6">
                                <div class="agent">
                                    <a href="agent-detail.html" class="agent-image">
                                      ...
                                      <img src="<c:url value="/img/member-01.jpg"/>" alt="">	</a>
                                    <div class="wrapper">
                            ...
                            <div class="col-md-12 col-lg-6">
                                <div class="agent">
                                    <a href="agent-detail.html" class="agent-image">
                                     <img src="<c:url value="/img/member-02.jpg"/>" alt="">	</a>
                                    <div class="wrapper">
                            ...
                            <div class="col-md-12 col-lg-6">
                                <div class="agent">
                                    <a href="agent-detail.html" class="agent-image">
                                     <img src="<c:url value="/img/client-01.jpg"/>" alt="">	</a>
