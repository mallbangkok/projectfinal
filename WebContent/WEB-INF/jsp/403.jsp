		...
		<div class="navigation">
			<div class="secondary-navigation">
				<div class="container">
					...
					<div class="user-area">
						<div class="actions">
							<a href="create-agency.jsp" class="promoted">Create Agency</a> <a
								href="create-account.html" class="promoted"><strong>Register</strong></a>
							<a href="sign-in.html">Sign In</a>
						</div>
						<div class="language-bar">
							<a href="#" class="active"> <img src="<c:url value="/img/flags/gb.png"/>" alt="">
					...
					<div class="navbar-header">
						...
						<div class="navbar-brand nav" id="brand">
							<a href="index-google-map-fullscreen.html"> <img
								src="<c:url value="/img/logo.png"/>" alt="brand">
							</a>
						</div>
					</div>
					<nav
			...
			<div class="container">
				<section id="403">
					<div class="error-page">
						<div class="title">
							<img src="<c:url value="/img/error-page-background.png"/>"
								class="top">
						...
						<a href="" class="link-arrow back" onclick="history.back(-1)">Go
							Back</a>
					</div>
				</section>
			</div>
