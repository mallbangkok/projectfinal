                ...
                <div class="col-md-9 col-sm-9">
                    <section id="results">
                        ...
                        <section id="properties" class="display-lines">
                            ...
                            <div class="property">
                                <figure class="type" title="House Boat"><img src="<c:url value="/img/property-types/houseboat.png"/>" alt=""></figure>
                                <div class="property-image">
                                    <a href="property-detail.html">
                            ...
                            <div class="property no-border">
                                <figure class="type" title="Single Family"><img src="<c:url value="/img/property-types/single-family.png"/>" alt=""></figure>
                            ...
                            <div class="property">
                                <figure class="tag status">For Sale</figure>
                                <figure class="type" title="Garage"><img src="<c:url value="/img/property-types/garage.png"/>" alt=""></figure>
                                <div class="property-image">
                                    <a href="property-detail.html">
