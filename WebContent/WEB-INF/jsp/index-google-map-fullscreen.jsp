...
<div class="wrapper">
            ...
            <header class="navbar" id="top" role="banner">
                <div class="navbar-header">
                    ...
                    <div class="navbar-brand nav" id="brand">
                        <a href="index-google-map-fullscreen"><img src="<c:url value="/img/logo1@1x.png"/>" alt="MALL BANGKOK"></a>
                    </div>
                </div>
    ...
    <div id="page-content">
        <section id="featured-properties" class="featured-properties block background-color-grey-light carousel-full-width">
            <div class="container">
                <header class="section-title"><h2>Mall Bangkok Update</h2></header>
            </div><!-- /.container -->
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="property">
                            ...
                            <a href="property-detail.html">
                                <div class="property-image">
                                   <img src="<c:url value="/img/properties/central-world.jpg"/>" alt="">
                                </div>
                                <div class="overlay">
                                    <div class="info">
                                        <div class="tag price">$ 11,000</div>
                    ...
                    <div class="col-sm-4">
                        <div class="property">
                        <figure class="tag status">The Other Popular Malls</figure>
                            <a href="property-detail.html">
                                <div class="property-image">
                                   <img src="<c:url value="/img/properties/futurepark.jpg"/>" alt="">
                                </div>
                                <div class="overlay">
                                    <div class="info">
