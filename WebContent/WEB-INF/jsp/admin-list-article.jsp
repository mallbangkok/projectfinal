...
<head>
    ...
    <title>Mall Bangkok | Admin List Article</title>
    ...
    <div id="page-content">
        ...
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="active">Admin List Article</li>
            </ol>
        </div>
        <!-- end Breadcrumb -->
                		...
                		<div class="col-md-9 col-sm-10">
                        	...
                        	<div class="my-properties">
                            	<div class="table-responsive">
                                    ...
                                    <tbody>
	                                    <c:forEach var="i" items="${listArticle}">
	                                    <tr>
	                                        <td>
	                                          	<div class="inner">
	                                            	<a href="#"><h2><c:out value="${i.articlename}"/></h2></a>
	                                        	</div>  
	                                        </td>
	                                        <td></td>
	                                        <td></td>
