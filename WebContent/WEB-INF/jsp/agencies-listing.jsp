...
<body class="page-sub-page page-agencies-listing" id="page-top">
					...
					<div class="user-area">
						...
						<div class="language-bar">
							<a href="#" class="active"> <img
								src="<c:url value="/img/flags/gb.png"/>" alt="">
							</a> <a href="#"> <img src="<c:url value="/img/flags/de.png"/>"
								alt="">
							</a> <a href="#"> <img src="<c:url value="/img/flags/es.png"/>"
								alt="">
							</a>
						</div>
					</div>
						...
						<ul class="nav navbar-nav">
							<li class="active has-child"><a href="#">Homepage</a>
								<ul class="child-navigation">
									<li><a href="index-google-map-fullscreen.html">Google
											Map Full Screen</a></li>
							...
							<li class="has-child"><a href="#">Properties</a>
								<ul class="child-navigation">
									...
									<li><a href="properties-listing-grid.html">Grid
											Listing</a></li>
									<li><a href="properties-listing-lines.html">Lines
											Listing</a></li>
								</ul></li>
				...
				<div class="row">
					...
					<div class="col-md-9 col-sm-9">
						<section id="agencies-listing">
							<header>
								<h1>Agencies Listing</h1>
							</header>
							<div class="agency">
								<a href="agency-detail.html" class="agency-image"> <img
									src="<c:url value="/img/agency-logo-01.png"/>" alt=""></a>

								<div class="wrapper">
									<header>
										<a href="agency-detail.html"><h2>Genius Properties</h2></a>
									</header>
									<dl>
										<dt>Phone:</dt>
										<dd>(123) 456 789</dd>
										...
										<dt>Email:</dt>
										<dd>
											<a href="mailto:#">agency@example.com</a>
										</dd>
										<dt>Skype:</dt>
										<dd>genius.properties</dd>
									</dl>
									<address>
										<strong>Address</strong> <br> <strong>Genius
											Properties</strong><br> 4877 Spruce Drive<br> West Newton,
										PA 15089
									</address>
								</div>
							</div>
							...
							<div class="agency">
								<a href="agency-detail.html" class="agency-image"> <img
									src="<c:url value="/img/agency-logo-02.png"/>" alt=""></a>
								<div class="wrapper">
									<header>
										<a href="agency-detail.html"><h2>House Trusted</h2></a>
									</header>
									<dl>
										<dt>Phone:</dt>
										<dd>(123) 456 789</dd>
									...
									<address>
										<strong>Address</strong> <br> <strong>House
											Trusted</strong><br> 4877 Spruce Drive<br> West Newton, PA
										15089
									</address>
								</div>
							</div>
							...
							<div class="agency">
								<a href="agency-detail.html" class="agency-image"><img
									src="<c:url value="/img/agency-logo-03.png"/>" alt=""></a>
								<div class="wrapper">
									<header>
										<a href="agency-detail.html"><h2>LightHouse Estate</h2></a>
									</header>
									<dl>
										<dt>Phone:</dt>
										<dd>(123) 456 789</dd>
									...
									<address>
										<strong>Address</strong> <br> <strong>LightHouse
											Estate</strong><br> 4877 Spruce Drive<br> West Newton, PA
										15089
									</address>
								</div>
							</div>
						...
						<section id="sidebar">
							...
							<aside id="featured-properties">
								...
								<div class="property small">
									<a href="property-detail.html">
										<div class="property-image">
											<img
									src="<c:url value="/img/properties/property-09.jpg"/>" alt="">
										</div>
									</a>
									<div class="info">
								...
								<div class="property small">
									<a href="property-detail.html">
										<div class="property-image">
											<img
									src="<c:url value="/img/properties/property-03.jpg"/>" alt="">
										</div>
									</a>
									<div class="info">
										<a href="property-detail.html"><h4>1949 Tennessee
												Avenue</h4></a>
										<figure>Minneapolis, MN 55402
										</figure>
							...
							<aside id="our-guides">
								...
								<a href="#" class="universal-button">
									<figure class="fa fa-home"></figure> <span>Buying Guide</span>
									<span class="arrow fa fa-angle-right"></span>
								</a>
								<!-- /.universal-button -->
								<a href="#" class="universal-button">
									<figure class="fa fa-umbrella"></figure> <span>Right
										Insurance for You</span> <span class="arrow fa fa-angle-right"></span>
								</a>
								<!-- /.universal-button -->
							</aside>
							<!-- /#our-guide -->
								...
								<article>
									...
									<div class="property small">
										<a href="property-detail.html">
											<div class="property-image">
												<img
									src="<c:url value="/img/properties/property-06.jpg"/>" alt="">
											</div>
										</a>
										<div class="info">
	...
	<script type="text/javascript"
		src="assets/js/jquery.numberformatter-1.2.3.js"></script>
	<script type="text/javascript" src="assets/js/tmpl.js"></script>
	<script type="text/javascript"
		src="assets/js/jquery.dependClass-0.1.js"></script>
