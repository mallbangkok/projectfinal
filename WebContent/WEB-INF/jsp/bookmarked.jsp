...
<link rel="stylesheet" href="css/style.css" type="text/css">
    ...
    <title>Zoner | Bookmarked Properties</title>
                ...
                <section id="sidebar">
                    ...
                    <aside>
                        <ul class="sidebar-navigation">
                            ...
                            <li class="active"><a href="bookmarked.html"><i class="fa fa-heart"></i><span>Bookmarked Properties</span></a></li>
                        </ul>
                    </aside>
                </section><!-- /#sidebar -->
            </div><!-- /.col-md-3 -->
                                ...
                                <a href="property-detail.html">
                                    <div class="property-image">
                                        <div class="overlay">
                                          ...
                                          <img src="<c:url value="/img/properties/masonry-03.jpg"/>" alt="">
                            ...
                            <div class="inner">
                                <a href="property-detail.html">
                                    <div class="property-image">
                                        ...
                                        <img src="<c:url value="/img/properties/masonry-01.jpg"/>" alt="">
                            ...
                            <div class="inner">
                                <a href="property-detail.html">
                                    <div class="property-image">
                                        ...
                                        <img src="<c:url value="/img/properties/masonry-02.jpg"/>" alt="">
                                    </div>
                                </a>
                                <aside>
                                    <header>
                                ...
                                <a href="property-detail.html">
                                    <div class="property-image">
                                        <div class="overlay">
                                          ...
                                          <img src="<c:url value="/img/properties/property-6.jpg"/>" alt="">
                                    </div>
                                </a>
                                <aside>
                                    <header>
